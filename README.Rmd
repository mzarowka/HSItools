...
HSItools is an R package to process and visualize hyperspectral core scanning data.![HSItools logo](man/figures/package_logo.png){width="192"}
...
Maurycy Żarczyński is founded by the Polish National Agency for Academic Exchange (BPN/BEK/2021/1/00133).![NAWA logo](man/figures/nawa_logo.png){width="192"}
