...
Here we present basic workflow for a single core. It is assumed that the output of `run_core()` function is available and stored on the disk.

We're using internal `HSItools` package data here, which has substantially reduced spatial and spectral resolution.
...
# Because it is a package, directory structure is not the same as in the real data.
```
...
#> ℹ 2024-02-24 17:53:15: reading rasters.
#> ℹ 2024-02-24 17:53:15: subsetting layers.
#> ℹ 2024-02-24 17:53:15: cropping rasters.
#> → Dark reference
#> |---------|---------|---------|---------|=========================================                                          
#> → Captured data
#> |---------|---------|---------|---------|=========================================                                          
#> → White reference
#> |---------|---------|---------|---------|=========================================                                          
#> ℹ 2024-02-24 17:53:16: calculating reference rasters.
#> → Aggregate DARKREF
...
#> |---------|---------|---------|---------|                                          
#> ℹ 2024-02-24 17:53:55: calculating reflectance raster.
#> |---------|---------|---------|---------|=========================================                                          
#> ℹ 2024-02-24 17:53:56: cleaning up.
#> ✔ 2024-02-24 17:53:56: finished.
```
...
#> 
#> ── REFLECTANCE_STL14_1A_28C_top_2022-11-11_16-30-51 ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ 2024-02-24 17:53:56: calculating Savitzky-Golay filtered raster.
#> |---------|---------|---------|---------|=========================================                                          
#> ✔ 2024-02-24 17:53:58: finished.
```
...
#> 
#> ── REFLECTANCE_STL14_1A_28C_top_2022-11-11_16-30-51_savitzky-golay ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ 2024-02-24 17:53:59: calculating continuum removed raster.
...
plot_ratio570630 <- ratio_570630 |>
  plot_raster_proxy(
    hsi_index = names(ratio_570630), palette = "magma")
#> 
#> ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
