...
proxies <- list(
  ...
  rabd_b1660b1690_b1670 = list(proxy_type = "RABD", proxy_name = "RABD1660:1690/1670", edges = c(1300, 1700), trough = 1665, reference = "NA", interpretation = "Terrestrial aromatic matter"),
  # Relative absorption band area = RABA
  raba_b650b700 = list(proxy_type = "RABA", proxy_name = "RABA650:700", edges = c(590, 730), trough = 675, reference = NA, interpretation = "Tchl-aHSI"),
  raba_b600b760 = list(proxy_type = "RABA", proxy_name = "RABA600:760", edges = c(590, 730), trough = 680, reference = NA, interpretation = "Tchl-aHSI"),
  raba_b590b730 = list(proxy_type = "RABA", proxy_name = "RABA590:730", edges = c(590, 730), trough = 660, reference = NA, interpretation = "Tchl-aHSI"),
  raba_b650b750 = list(proxy_type = "RABA", proxy_name = "RABA650:750", edges = c(590, 730), trough = 700, reference = NA, interpretation = "Tchl-aHSI"),
  raba_b650b700rmean = list(proxy_type = "RABA/Rmean", proxy_name = "RABA650:700/Rmean", edges = c(590, 730), trough = 675, reference = "NA", interpretation = "Tchl-aHSI"),
  raba_b600b760rmean = list(proxy_type = "RABA/Rmean", proxy_name = "RABA600:760/Rmean", edges = c(590, 730), trough = 680, reference = "NA", interpretation = "Tchl-aHSI"),
  raba_b590b730rmean = list(proxy_type = "RABA/Rmean", proxy_name = "RABA590:730/Rmean", edges = c(590, 730), trough = 660, reference = "NA", interpretation = "Tchl-aHSI"),
  raba_b650b750rmean = list(proxy_type = "RABA/Rmean", proxy_name = "RABA650:750/Rmean", edges = c(590, 730), trough = 700, reference = "NA", interpretation = "Tchl-aHSI"),
  # Band ratios
  ...
  rmean = list(proxy_type = "general", proxy_name = "Rmean", edges = NA, trough = NA, reference = NA, interpretation = "Mean reflectance over the entire spectrum")
)
