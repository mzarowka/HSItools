...
", interpretation = "albite"),
  ...
  rabd_b660b670 = list(proxy_type = "rabd", proxy_name = "rabd660670", edges = c(590, 730), trough = 660:670, reference = "na", interpretation = "tchl-ahsi"),
  rabd_b845 = list(proxy_type = "rabd", proxy_name = "rabd845", edges = c(790, 900), trough = 845, reference = "na", interpretation = "bphe-ahsi"),
...
# Band ratios
  ...
  ratio_b590b690 = list(proxy_type = "band ratio", proxy_name = "r590r690", edges = c(590, 690), trough = NA, reference = "na", interpretation = "clay minerals, dust"),
