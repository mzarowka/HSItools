...
proxies <- list(
  ...
  raba_b650b700 = list(proxy_type = "raba", proxy_name = "raba660670", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b600b760 = list(proxy_type = "raba", proxy_name = "raba660670", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b590b730 = list(proxy_type = "raba", proxy_name = "raba660670", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b650b750 = list(proxy_type = "raba", proxy_name = "raba660670", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b650b700rmean = list(proxy_type = "raba/rmean", proxy_name = "raba660670_rmean", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b600b760rmean = list(proxy_type = "raba/rmean", proxy_name = "raba660670_rmean", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b590b730rmean = list(proxy_type = "raba/rmean", proxy_name = "raba660670_rmean", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  raba_b650b750rmean = list(proxy_type = "raba/rmean", proxy_name = "raba660670_rmean", edges = c(590, 730), trough = 665, reference = "na", interpretation = "tchl-ahsi"),
  # band ratios
